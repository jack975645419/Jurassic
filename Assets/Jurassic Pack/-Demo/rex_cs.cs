...
public class rex_cs : MonoBehaviour
{
	...
	public Texture[] skin;
	public AudioClip Bigstep,Idlecarn,Rex_Roar1,Rex_Roar2,Carngrowl1,Carngrowl2,Bite,Swallow,Sniff1;

	void Awake ()
	{
		Tail1 = this.transform.Find ("Rex/root/tail0/tail1");
		Tail2 = this.transform.Find ("Rex/root/tail0/tail1/tail2");
		Tail3 = this.transform.Find ("Rex/root/tail0/tail1/tail2/tail3");
		Tail4 = this.transform.Find ("Rex/root/tail0/tail1/tail2/tail3/tail4");
		Tail5 = this.transform.Find ("Rex/root/tail0/tail1/tail2/tail3/tail4/tail5");
		Tail6 = this.transform.Find ("Rex/root/tail0/tail1/tail2/tail3/tail4/tail5/tail6");
		Spine0 = this.transform.Find ("Rex/root/spine0");
		Spine1 = this.transform.Find ("Rex/root/spine0/spine1");
		Spine2 = this.transform.Find ("Rex/root/spine0/spine1/spine2");
		Neck0 = this.transform.Find ("Rex/root/spine0/spine1/spine2/spine3/neck0");
		Neck1 = this.transform.Find ("Rex/root/spine0/spine1/spine2/spine3/neck0/neck1");
		Neck2 = this.transform.Find ("Rex/root/spine0/spine1/spine2/spine3/neck0/neck1/neck2");
		Head = this.transform.Find ("Rex/root/spine0/spine1/spine2/spine3/neck0/neck1/neck2/head");
		Jaw = this.transform.Find ("Rex/root/spine0/spine1/spine2/spine3/neck0/neck1/neck2/head/jaw0");
	...
	void Update ()
	{
		...
		if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|EatA") ||
		    ...
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkShake"))
		...
		if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand1B"))
		{
			if(animcount==0 && soundplayed==false)
			{
				...
				source.PlayOneShot(Rex_Roar1,Random.Range(0.75F, 1.0F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand2C"))
		{
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Rex_Roar2,Random.Range(0.75F, 1.0F));
				soundplayed=true;
			}
			else if(animcount!=0) soundplayed=false;
		}
		...
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1ToRun"))
		{
			...
			else if(animcount==25 && soundplayed==false)
			{
				...
				soundplayed=true;
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkShake") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkShake") ||
	...
	//Model translations and rotations
		    ...
		    anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkShake"))
		{
			...
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunToStand1") &&
				...
				velocity =0.0F;
			else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunToStand1") && (velocity > 0.0F))
			{
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2ToRun"))
		{
			...
			if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunGrowl") ||
				anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunGrowl"))
			{
				if (velocity > 0.6F)
				{
