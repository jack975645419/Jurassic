...
public class raptor_cs : MonoBehaviour {
	...
	public Texture[] skin;
	public AudioClip Smallstep,Idlecarn,Rap_Roar1,Rap_Roar2,Rap_Attack1,Rap_Attack2,Rap_Attack3,Rap_Bark,Sniff1,Bite;



	void Awake ()
	{
		Tail0 = this.transform.Find ("Raptor/root/pelvis/tail0");
		Tail1 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1");
		Tail2 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2");
		Tail3 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3");
		Tail4 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4");
		Tail5 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5");
		Tail6 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6");
		Tail7 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7");
		Tail8 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8");
		Tail9 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9");
		Tail10 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9/tail10");
		Tail11 = this.transform.Find ("Raptor/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9/tail10/tail11");
		Spine0 = this.transform.Find ("Raptor/root/spine0");
		Spine1 = this.transform.Find ("Raptor/root/spine0/spine1");
		Spine2 = this.transform.Find ("Raptor/root/spine0/spine1/spine2");
		Spine3 = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3");
		Spine4 = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4");
		Spine5 = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5");
		Arm1 = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/left arm0");
		Arm2 = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/right arm0");
		Neck0  = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0");
		Neck1  = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1");
		Neck2  = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2");
		Neck3  = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3");
		Head   = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3/head");
		Jaw    = this.transform.Find ("Raptor/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3/head/jaw0");
	...
	void Update ()
	{
		...
		if (Input.GetKey (KeyCode.Space) &&
		    !anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|JumpLoop") &&
		    !anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|JumpLoop") &&
		    !anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandJumpDown") &&
		    !anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandJumpDown") &&
		    !anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown") &&
		    !anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown")) anim.SetBool("Onground", false); //Jump
		...
		if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|SleepLoop") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Die") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandE") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|EatA") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|EatB") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandEat") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|GroundAttack")
		...
		if (Input.GetKey (KeyCode.E) && (
			anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Strafe+") ||
			anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Strafe-")))
		...
		if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|SleepLoop") ||
			anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|SleepLoop"))
		{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandA") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandA") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|GroundStand") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|GroundStand") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StepsStand") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StepsStand"))
		{
			if(soundplayed==false && animcount==15)
			{
				source.pitch=Random.Range(1.1F, 1.25F);
				source.PlayOneShot(Sniff1,Random.Range(0.1F, 0.2F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandB") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandB"))
		{
			if(soundplayed==false && animcount==15)
			{
				source.pitch=Random.Range(1.1F, 1.25F);
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandC") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandC"))
		{
			if(soundplayed==false && animcount==2)
			{
				source.pitch=Random.Range(0.9F, 1.1F);
				source.PlayOneShot(Rap_Roar1,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandD") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandD"))
		{
			if(soundplayed==false &&(animcount==1 || animcount==8 || animcount==16))
			{
				source.pitch=Random.Range(0.9F, 1.1F);
				source.PlayOneShot(Rap_Bark,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandE") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandE"))
		{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|EatA") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|EatA"))
		{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|AttackA") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|AttackA")||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|AttackB") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|AttackB"))
		{
			if(soundplayed==false &&(animcount==2))
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Rap_Attack1,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunAttackA") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunAttackA"))
		{
			if(soundplayed==false &&(animcount==2))
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Rap_Attack2,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunAttackB") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunAttackB"))
		{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|JumpLoopAttack") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|JumpLoopAttack"))
		{
			if(soundplayed==false &&(animcount==15))
			{
				source.pitch=Random.Range(1.0F, 1.25F);
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|JumpAttack") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|JumpAttack"))
		{
			if(soundplayed==false &&(animcount==3))
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Rap_Attack3,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|GroundAttack") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|GroundAttack"))
		{
			if(soundplayed==false &&(animcount==3))
			{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Walk") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Walk") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|WalkGrowl") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|WalkGrowl"))
		{
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Rap_Roar2,Random.Range(0.75F, 1.00F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|WalkToStand") ||
				 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|WalkToStand") ||
				 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandToWalk") ||
				 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandToWalk") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunToStand") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunToStand"))
		{
		...
		else if ( anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Steps-") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Steps-"))
		{
		...
		else if ( anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Strafe-") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Strafe-") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Strafe+") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Strafe+"))
		{
			if(soundplayed==false && (animcount==12 || animcount==26))
			{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StepsGrowl+") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StepsGrowl+") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StepsGrowl-") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StepsGrowl-"))
		{
			if(soundplayed==false && animcount==4)
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Rap_Roar1,Random.Range(0.75F, 1.00F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Run") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Run") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunGrowl") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunGrowl"))
		{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandJumpUp") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandJumpUp") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunJumpUp") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunJumpUp"))
		{
			if(soundplayed==false && animcount==4)
			{
				source.pitch=Random.Range(1.5F, 2.0F);
				source.PlayOneShot(Sniff1,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
			else if(animcount!=4 ) soundplayed=false;
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandJumpDown") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandJumpDown") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown"))
		{
			if(soundplayed==false && animcount==4)
			{
		...
		else if (!isdead && ( anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Die") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Die")))
		{
			if(soundplayed==false && animcount==4)
			{
				source.pitch=Random.Range(0.75F, 1.0F);
				source.PlayOneShot(Rap_Roar2,Random.Range(0.5F, 1.0F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Rise") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Rise"))
		{
			isdead=false;
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Rap_Attack2,Random.Range(0.5F, 1.0F));
				soundplayed=true;
			}
	...
	void LateUpdate()
	{
			...
			if (anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Run") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Run") ||
			    anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunGrowl") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunGrowl"))
			{
	...
	void FixedUpdate ()
	{
		...
		//Walking
		if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Walk") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|Walk") ||
				 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|WalkGrowl") ||
				 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|WalkGrowl") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|WalkToStand") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunToStand") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunToStand") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|WalkToStand") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandToWalk") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandToWalk"))
		{
			...
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|WalkToStand") &&
		...
		//Running
			     ...
			     anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunGrowl") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunAttackA") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunAttackA") ||
			     anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunAttackB") ||
			     anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunAttackB") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown"))
		{
			if(Input.GetKey(KeyCode.A))
			...
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunAttackA") &&
		...
		//Forward steps
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|Steps+") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StepsGrowl+"))
		{
		...
		//Stand jump
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandJumpUp") ||
			anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandJumpUp"))
		{
		...
		//Running jump
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunJumpUp") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunJumpUp"))
		{
			anim.SetBool("Onground", false);
		...
		//Jump loop
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|JumpLoop") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|JumpLoop") ||
			     anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|JumpLoopAttack") ||
			     anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|JumpLoopAttack"))
		{
		...
		//Jump landing
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandJumpDown") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|StandJumpDown") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Raptor|RunJumpDown"))
		{
		...
		//Jump Attack
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|JumpAttack"))
		{
		...
		//Stop
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StandA") ||
			     anim.GetCurrentAnimatorStateInfo (0).IsName ("Raptor|StepsStand"))
				{
					velocity =0.0F;
					this.transform.Translate (0, 0, velocity*Scale);
