...
public class dilo_cs : MonoBehaviour {
	...
	public Texture[] skin;
	public AudioClip Smallstep,Idlecarn,Dilo_Roar1,Dilo_Roar2,Dilo_Call1,Dilo_Call2,Dilo_Call3,Dilo_Call4,Bite;


	void Awake ()
	{
		Tail0 = this.transform.Find ("Dilo/root/pelvis/tail0");
		Tail1 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1");
		Tail2 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2");
		Tail3 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3");
		Tail4 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4");
		Tail5 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5");
		Tail6 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6");
		Tail7 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7");
		Tail8 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8");
		Tail9 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9");
		Tail10 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9/tail10");
		Tail11 = this.transform.Find ("Dilo/root/pelvis/tail0/tail1/tail2/tail3/tail4/tail5/tail6/tail7/tail8/tail9/tail10/tail11");
		Spine0 = this.transform.Find ("Dilo/root/spine0");
		Spine1 = this.transform.Find ("Dilo/root/spine0/spine1");
		Spine2 = this.transform.Find ("Dilo/root/spine0/spine1/spine2");
		Spine3 = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3");
		Spine4 = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4");
		Spine5 = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5");
		Arm1 = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/left arm0");
		Arm2 = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/right arm0");
		Neck0  = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0");
		Neck1  = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1");
		Neck2  = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2");
		Neck3  = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3");
		Head   = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3/head");
		Jaw    = this.transform.Find ("Dilo/root/spine0/spine1/spine2/spine3/spine4/spine5/neck0/neck1/neck2/neck3/head/jaw0");
	...
	void Update ()
	{
		...
		if (Input.GetKey (KeyCode.Space) &&
		    ...
		    !anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|RunJumpDown")) anim.SetBool("Onground", false); //Jump
		...
		if (anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|SleepLoop") ||
			anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|SleepLoop"))
		{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|StandA") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|StandA") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|GroundStand") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|GroundStand") ||
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|StepsStand") ||
		    	 anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|StepsStand"))
		{
			if(soundplayed==false && animcount==15)
			{
				...
				source.PlayOneShot(Dilo_Call2,Random.Range(0.4F, 0.5F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|StandB") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|StandB"))
		{
			if(soundplayed==false && animcount==1)
			{
				...
				source.PlayOneShot(Dilo_Call4,Random.Range(0.4F, 0.5F));
				soundplayed=true;
			}
		    ...
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|StandC"))
		{
			if(soundplayed==false && animcount==1)
			{
				...
				source.PlayOneShot(Dilo_Call2,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
			else if(soundplayed==false && animcount==8)
			{
				source.pitch=Random.Range(0.9F, 1.1F);
				source.PlayOneShot(Dilo_Roar1,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
			else if(animcount!=1 && animcount!=8 ) soundplayed=false;
		}
		    ...
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|StandD"))
		{
			...
			{
				source.pitch=Random.Range(0.9F, 1.1F);
				source.PlayOneShot(Dilo_Roar2,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
			else if(animcount!=1) soundplayed=false;
		}
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|EatA"))
		{
			...
			if(soundplayed==false && animcount==6)
			{
				...
				source.PlayOneShot(Idlecarn,Random.Range(0.1F, 0.3F));
				soundplayed=true;
			}
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|RunAttackB"))
		{
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Dilo_Call1,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
			else if(soundplayed==false &&(animcount==15))
			{
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|GroundAttack") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|GroundAttack"))
		{
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|WalkGrowl"))
		{
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Dilo_Call2,Random.Range(0.75F, 1.00F));
				soundplayed=true;
			}
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|StepsGrowl-"))
		{
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Dilo_Roar1,Random.Range(0.75F, 1.00F));
				soundplayed=true;
			}
		...
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|StepsStandGrowl") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|StepsStandGrowl"))
		{
			if(soundplayed==false && (animcount==4))
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Dilo_Call4,Random.Range(0.5F, 0.5F));
				soundplayed=true;
			}
			else if(soundplayed==false && (animcount==16))
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Dilo_Call3,Random.Range(0.5F, 0.5F));
				soundplayed=true;
			}
			else if(animcount!=4 && animcount!=16) soundplayed=false;
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|RunGrowl"))
		{
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Dilo_Call3,Random.Range(0.75F, 1.00F));
				soundplayed=true;
			} 
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|RunJumpUp"))
		{
			...
			{
				source.pitch=Random.Range(1.5F, 2.0F);
				source.PlayOneShot(Dilo_Call4,Random.Range(0.5F, 0.75F));
				soundplayed=true;
			}
			else if(animcount!=4 ) soundplayed=false;
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|Die")))
		{
			...
			{
				source.pitch=Random.Range(0.75F, 1.0F);
				source.PlayOneShot(Dilo_Call3,Random.Range(0.5F, 1.0F));
				soundplayed=true;
			}
		         ...
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|Rise"))
		{
			...
			{
				source.pitch=Random.Range(1.0F, 1.25F);
				source.PlayOneShot(Dilo_Call2,Random.Range(0.5F, 1.0F));
				soundplayed=true;
			}
	...
	void LateUpdate()
	{
		if(anim.enabled==true)
		{
			...
			if (anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|Run") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|Run") ||
			    anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|RunGrowl") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|RunGrowl"))
			{
...
void FixedUpdate ()
{
		    	 ...
		    	 anim.GetNextAnimatorStateInfo (0).IsName ("Dilo|StandToWalk"))
		{
			...
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Dilo|WalkToStand") &&
